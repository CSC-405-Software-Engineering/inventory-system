...
const MetaTags = ({ title, description, keywords, pageUrl }: MetaTagsProps) => {
  return (
    <Helmet>
      ...
      <meta charSet="utf-8" />
      <link rel="icon" href={'/assets/icons/app-icon.svg'} />
      <link rel="canonical" href={`${pageUrl}`} />
      <title>{title}</title>
      <meta name="og:title" content={title} />
      <meta name="og:description" content={description} />
      <meta name="og:image" content={'/assets/icons/app-icon.svg'} />
      <meta name="og:url" content={`${pageUrl}`} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content={title} />
      <meta name="twitter:description" content={description} />
      <meta name="twitter:image" content={'/assets/icons/app-icon.svg'} />
    </Helmet>
  );
};
