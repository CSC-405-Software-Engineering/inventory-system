...
const PantryTab: React.FC<TabsWithIconsProps> = ({ items, activeTab, setActiveTab }) => {
                                ...
                                {items.map((item, index) => (
                                    ...
                                    >
                                        <div className='flex flex-row items-center gap-1 py-1.5'>
                                            ...
                                            <p style={{ color: index === activeTab ? '#B11722' : "#9E9E9E" }} className='text-[12px] font-[600]'>
                                                {item.label}
                                            </p>
                                            <div style={{ backgroundColor: index === activeTab ? '#EED4D5' : '#A4A4A457', color: index === activeTab ? '#B11722' : '#939393' }} className='w-[25px] h-[16px] rounded-[9px] font-[600] text-[10px]'>
                                                {item.count}
                                            </div>
                                        </div>
                                    </button>
                        ...
                        <div className="flex flex-col gap-[24px] items-end">
                            <div className="flex flex-row gap-[8px] w-[360px] h-[36px] py-[18px] px-[16px] items-center rounded-[8px] border-[1px] border-[#D9D9D9] bg-white focus:ring-red-800">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M12.5 12.0602C13.5229 11.1447 14.1667 9.81417 14.1667 8.33334C14.1667 5.57191 11.9281 3.33334 9.16666 3.33334C6.40523 3.33334 4.16666 5.57191 4.16666 8.33334C4.16666 11.0948 6.40523 13.3333 9.16666 13.3333C10.4472 13.3333 11.6154 12.8519 12.5 12.0602ZM12.5 12.0602L16.2732 15.8333" stroke="#52525C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <input type="text" placeholder="Search an item" className=" border-none py-0 focus:outline-none focus:bg-none focus:ring-0" />
                            ...
                            <div className="flex flex-row items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                                    <g clip-path="url(#clip0_148_694)">
                                        ...
                                        <path d="M6.58621 9.28876L2.29749 5.00004L6.58619 0.711342C6.74909 0.548434 6.74909 0.285097 6.58619 0.122189C6.42328 -0.0407194 6.15994 -0.0407194 5.99703 0.122189L1.41375 4.70548C1.25084 4.86838 1.25084 5.13172 1.41375 5.29463L5.99703 9.87792C6.07828 9.95916 6.18494 10 6.29162 10C6.39828 10 6.50496 9.95916 6.58621 9.87792C6.74911 9.71501 6.74911 9.45167 6.58621 9.28876Z" fill="black" />
                                        <path d="M6.58621 9.28876L8.00042 7.87455L6.58621 9.28876ZM2.29749 5.00004L0.883272 3.58583L-0.530941 5.00004L0.883272 6.41426L2.29749 5.00004ZM6.58619 0.711342L5.17197 -0.702871V-0.702871L6.58619 0.711342ZM5.99703 0.122189L4.58282 -1.29202L5.99703 0.122189ZM1.41375 4.70548L2.82796 6.11969H2.82796L1.41375 4.70548ZM1.41375 5.29463L-0.00046742 6.70884L1.41375 5.29463ZM5.99703 9.87792L7.41125 8.4637L5.99703 9.87792ZM8.00042 7.87455L3.7117 3.58583L0.883272 6.41426L5.17199 10.703L8.00042 7.87455ZM3.7117 6.41426L8.0004 2.12556L5.17197 -0.702871L0.883272 3.58583L3.7117 6.41426ZM8.0004 2.12556C8.94436 1.1816 8.94436 -0.348068 8.0004 -1.29202L5.17197 1.5364C4.55383 0.918262 4.55383 -0.0847311 5.17197 -0.702871L8.0004 2.12556ZM8.0004 -1.29202C7.05644 -2.23598 5.52678 -2.23598 4.58282 -1.29202L7.41125 1.5364C6.79311 2.15454 5.79011 2.15454 5.17197 1.5364L8.0004 -1.29202ZM4.58282 -1.29202L-0.00046742 3.29126L2.82796 6.11969L7.41125 1.5364L4.58282 -1.29202ZM-0.00046742 3.29126C-0.944424 4.23522 -0.944424 5.76489 -0.00046742 6.70884L2.82796 3.88042C3.4461 4.49856 3.4461 5.50155 2.82796 6.11969L-0.00046742 3.29126ZM-0.00046742 6.70884L4.58282 11.2921L7.41125 8.4637L2.82796 3.88042L-0.00046742 6.70884ZM4.58282 11.2921C5.05328 11.7626 5.67484 12 6.29162 12V8C6.69504 8 7.10329 8.15574 7.41125 8.4637L4.58282 11.2921ZM6.29162 12C6.90833 12 7.52993 11.7626 8.00042 11.2921L5.17199 8.4637C5.47999 8.15571 5.88823 8 6.29162 8V12ZM8.00042 11.2921C8.94438 10.3482 8.94438 8.81851 8.00042 7.87455L5.17199 10.703C4.55385 10.0848 4.55385 9.08184 5.17199 8.4637L8.00042 11.2921Z" fill="black" mask="url(#path-1-inside-1_148_694)" />
                                    </g>
                                    <defs>
...
const Pantry = () => {
    ...
    const tabItems: TabItem[] = [
        { label: 'All', count: 10 },
        { label: 'Fridge', icon: (isActive: boolean) => <FrigdeTabIcon isActive={isActive} />, count: 5 },
        { label: 'Freezer', icon: (isActive: boolean) => <FreezerTabIcon isActive={isActive} />, count: 3 },
        { label: 'Dry Pantry', icon: (isActive: boolean) => <DryPantryIcon isActive={isActive} />, count: 7 },
    ];
    return (
        <>
            <PantryTab items={tabItems} activeTab={activeTab} setActiveTab={setActiveTab} />
        </>
    );
};
